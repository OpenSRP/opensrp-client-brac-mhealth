...
public class HnppNavigationModel implements org.smartregister.chw.core.model.NavigationModel.Flavor {
    ...
    public List<NavigationOption> getNavigationItems() {
        if (navigationOptions.size() == 0) {
            ...
            if(HnppConstants.isPkLogin()){
                ...
                optionChild.setNavigationSubModel(getChildSubMenu());
    ...
    private ArrayList<NavigationSubModel> getChildSubMenu(){
        ArrayList<NavigationSubModel> subModels = new ArrayList<>();
        NavigationSubModel zeroToSix = new NavigationSubModel(R.string.menu_child_0_6,0,CoreConstants.DrawerMenu.CHILD_0_6);
        NavigationSubModel sevenTo24 = new NavigationSubModel(R.string.menu_child_7_24,0,CoreConstants.DrawerMenu.CHILD_7_24);
        NavigationSubModel twentyFiveTo60 = new NavigationSubModel(R.string.menu_child_25_60,0,CoreConstants.DrawerMenu.CHILD_25_60);
        NavigationSubModel riskyChild = new NavigationSubModel(R.string.menu_anc_risk_clients,0,CoreConstants.DrawerMenu.CHILD_RISK);

        subModels.add(zeroToSix);
        subModels.add(sevenTo24);
        subModels.add(twentyFiveTo60);
        subModels.add(riskyChild);
        return subModels;
