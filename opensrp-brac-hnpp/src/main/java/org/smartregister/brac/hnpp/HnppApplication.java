...
import org.smartregister.brac.hnpp.activity.HnppChildSevenTwentyFourRegisterActivity;
import org.smartregister.brac.hnpp.activity.HnppChildTwentyFiveSixtyRegisterActivity;
import org.smartregister.brac.hnpp.activity.HnppChildZeroSixRegisterActivity;
...
//        context.userService().logoutSession();
    ...
    public @NotNull Map<String, Class> getRegisteredActivities() {
        ...
        registeredActivities.put(CoreConstants.REGISTERED_ACTIVITIES.CHILD_0_6_REGISTER_ACTIVITY, HnppChildZeroSixRegisterActivity.class);
        registeredActivities.put(CoreConstants.REGISTERED_ACTIVITIES.CHILD_7_24_REGISTER_ACTIVITY, HnppChildSevenTwentyFourRegisterActivity.class);
        registeredActivities.put(CoreConstants.REGISTERED_ACTIVITIES.CHILD_25_60_REGISTER_ACTIVITY, HnppChildTwentyFiveSixtyRegisterActivity.class);
